 ...
 * 音量对话框（语音左声道，音乐右声道）
 */
class VolumeDialogForAudioLeft extends AVolumeDialog {
    /**
     * 构造器
     * @param context    应用程序上下文
     * @param themeResId 主题ID
     */
    public VolumeDialogForAudioLeft(Context context, int themeResId) {
        ...
        ui.musicVolumeSeekBar.setProgress((int) (getOption().getAudioRightVolume() * 100));
    ...
    protected void updateVolume() {
        //更新语音音量
        float leftVolume = ((float)ui.audioVolumeSeekBar.getProgress()) / 100;
        float rightVolume = ((float)ui.musicVolumeSeekBar.getProgress()) / 100;
