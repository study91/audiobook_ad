 ...
 * 内容视图页适配器
 */
class ContentViewPager1Adapter extends PagerAdapter{
     ...
     */
    public ContentViewPager1Adapter(Context context) {
        m.context = context;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View view = layoutInflater.inflate(R.layout.content_view1, null);
        ...
        ui.titleTextView = (TextView) view.findViewById(R.id.titleTextView); //标题
        ui.originalScrollView = (ScrollView) view.findViewById(R.id.originalScrollView); //原文滚动视图
        ui.originalTextView = (TextView) view.findViewById(R.id.originalTextView); //原文
        ui.explainScrollView = (ScrollView) view.findViewById(R.id.explainScrollView); //详解滚动视图
        ...
        ui.titleTextView.setText(catalog.getTitle()); //设置标题
        ui.titleTextView.setTextSize(getOption().getContentFontSize());
        ...
        ui.titleTextView.setTag("TitleTextView" + position); //标题文本框
        ui.originalTextView.setTag("OriginalTextView" + position); //原文文本框
        ui.explainTextView.setTag("ExplainTextView" + position); //详解文本框
        ui.originalScrollView.setTag("OriginalScrollView" + position); //原文滚动条
        ui.explainScrollView.setTag("ExplainScrollView" + position); //详解滚动条
